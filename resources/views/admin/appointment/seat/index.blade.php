...
<style>
    ...
    /* Booked Seat Styling */
    .booked {
        background-color: #d40000cf;
        /* Gray for booked seats */
        cursor: not-allowed;
    }
    ...
    .available {
        ...
        /* Bright cyan for available seats */
    }
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 seat-selection">Seat Selection</h1>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="seat-selection-container">
                            ...
                            <div class="seat-grid">
                                ...
                                <div class="seat-item {{ in_array($seat->id, $bookedSeats) ? 'booked' : 'available' }}"
                                    data-toggle="tooltip" title="{{ $seat->line }}">
