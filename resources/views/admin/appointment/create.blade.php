                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="appointment_name" id="appointment_name" class="form-control @error('appointment_name') is-invalid @enderror" placeholder="Enter appointment name" value="{{ old('appointment_name') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="coach_id" id="coach_id" class="form-control select2 @error('coach_id') is-invalid @enderror">
                                            ...
                                            @foreach($coaches as $coach)
                                                <option value="{{ $coach->id }}" {{ old('coach_id') == $coach->id ? 'selected' : '' }}>{{ $coach->user->first_name }} {{ $coach->user->last_name }}</option>
                                            @endforeach
                                        </select>
                                        @error('coach_id')
                                            <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="location" id="location" class="form-control @error('location') is-invalid @enderror" placeholder="Enter location" value="{{ old('location') }}">
                                        @error('location')
                                            <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </div>
