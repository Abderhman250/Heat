    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Update Admin Manager</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                            <li class="breadcrumb-item active">Update Admin Manager</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Edit Admin Manager</h3>
                    </div>
                    <div class="card-body">
                        <!-- Validation Errors -->
                        @if ($errors->any())
                        ...
                        <form action="{{ route('admin.admins.update', $admin->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <input type="hidden" name="user_id" class="form-control" value="{{ $admin->id }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="country_code" class="form-control @error('country_code') is-invalid @enderror" 
                                               value="{{ old('country_code', $admin->country_code) }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="dob" id="dob" class="form-control @error('dob') is-invalid @enderror" value="{{ old('dob', $admin->dob) }}">
                                        @error('dob')
                                ...
                                <!-- <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        @if($admin->photo)
                                            <small>Current Photo: <a href="{{ $admin->photo }}" target="_blank">View</a></small>
                                        @endif
