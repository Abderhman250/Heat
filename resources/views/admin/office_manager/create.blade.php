    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Manage Office Manager</h1>
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Office Manager</h3>
                    </div>
                    <div class="card-body">
                        <!-- Validation Errors -->
                        @if ($errors->any())
                        ...
                        <!-- Form Start -->
                        <form action="{{ route('admin.office_manager.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="box-footer text-right">
                                        <button type="submit" class="btn btn-primary">Create Office Manager</button>
                                    </div>
                                </div>
                            </div>
                        </form>
